...
bySubjectLabel <- group_by(tidySet, subject, activityName)
meanOfTidySet <- summarise_all(bySubjectLabel, mean)
meanOfTidySet[69:70] <- NULL

## Writing txt file
write.table(meanOfTidySet, file = "meanOfTidySetMeanStdTrainTestAllMeasuresByActivitySubject.txt", row.names = FALSE)
